...
```typ
#import "@local/oxifmt:1.0.0": strfmt
...
- `oxifmt:0.2.0` is now available through Typst's Package Manager! You can now write `#import "@local/oxifmt:0.2.0": strfmt` to use the library.
